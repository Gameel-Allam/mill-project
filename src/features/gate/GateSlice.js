...
export const gateSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(AddVisitData.fulfilled, (state) => {
        state.loading = false;
        state.success = true;
        // هنا
      ...
      .addCase(editVisitData.fulfilled, (state) => {
        state.loading = false;
        state.success = true;
...
export const { closeModal, openGateModal, closeGateModal, updataAddFormData, ResetValues, updataEditFormData, updateCurrentPage } = gateSlice.actions;
